            ...
            <div class="row align-items-baseline">
                <div class="col-lg-12 col-md-12 mb-5">
                    <div class="section-head left wt-small-separator-outer">
                        <h2 class="wt-title">
                            How does obillia work for seller?
                        </h2>
                    </div>
                </div>
                        ...
                        <div class="row">
                                ...
                                <div class="d-flex gap-3">
                                    ...
                                    <span class="text-clr-sky svg-holder">
                                        ...
                                        <svg aria-hidden="true" focusable="false" data-prefix="fa-regular"
                                            data-icon="users-medical" class="svg-inline--fa fa-users-medical fa-w-20"
                            ...
                            <div data-aos="fade-up" data-aos-offset="200" data-aos-duration="500" class="col-md-12">
                                <div class="d-flex gap-3">
                                    ...
                                    <span class="text-clr-sky svg-holder">
                                        <svg aria-hidden="true" focusable="false" data-prefix="fa-regular"
                                            data-icon="screen-users" class="svg-inline--fa fa-screen-users fa-w-20"
                                            role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                                            <path
                            ...
                            <div data-aos="fade-up" data-aos-offset="200" data-aos-duration="500" class="col-md-12">
                                <div class="d-flex gap-3">
                                    ...
                                    <span class="text-clr-sky svg-holder">
                                        <svg aria-hidden="true" focusable="false" data-prefix="fa-regular"
                                            data-icon="database" class="svg-inline--fa fa-database fa-w-14"
                            ...
                            <div data-aos="fade-up" data-aos-offset="200" data-aos-duration="500" class="col-md-12">
                                <div class="d-flex gap-3">
                                    ...
                                    <span class="text-clr-sky svg-holder">
                                        <svg aria-hidden="true" focusable="false" data-prefix="fa-regular"
                                            data-icon="shield-check" class="svg-inline--fa fa-shield-check fa-w-16"
