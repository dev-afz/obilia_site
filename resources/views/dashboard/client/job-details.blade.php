            ...
            <script>
                ...
                $(document).ready(function() {
                    ...
                    $(document).on('click', '[data-invite-candidate]', function(e) {
                        ...
                        rebound({
                            ...
                            url: "{{ route('client.job.invite-candidate') }}",
                            block: false,
                            processData: true,
                    ...
                    $(document).on('click', '[data-application-action]', function(e) {
                        ...
                        rebound({
                            ...
                            url: "{{ route('client.job.application-action') }}",
                            block: false,
                            processData: true,
                            successCallback: function(data) {
                                btn.parent().remove();
                ...
                function fetchSuggestedJobs() {
                    ...
                    rebound({
                        ...
                        block: false,
                        notification: false,
                        url: "{{ route('client.job.suggested-candidates') }}",
                        processData: true,
                ...
                function fetchApplicantions() {
                    ...
                    rebound({
                        ...
                        block: false,
                        notification: false,
                        url: "{{ route('client.job.applications') }}",
                        processData: true,
                        successCallback: function(res) {
                            if (res.status === 'success') {
                ...
                function fetchInvitedCandidates() {
                    ...
                    rebound({
                        ...
                        block: false,
                        notification: false,
                        url: "{{ route('client.job.invited-candidates') }}",
                        processData: true,
                        successCallback: function(res) {
                            if (res.status === 'success') {
                ...
                function fetchHiredCandidates() {
                    ...
                    rebound({
                        ...
                        block: false,
                        notification: false,
                        url: "{{ route('client.job.hired-candidates') }}",
                        processData: true,
                        successCallback: function(res) {
                            if (res.status === 'success') {
