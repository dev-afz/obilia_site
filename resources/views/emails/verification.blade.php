                                ...
                                <td class="o_bg-dark o_px o_py-md o_br-t o_sans o_text" align="center"
                                    ...
                                    <p style="margin-top: 0px;margin-bottom: 0px;"><a class="o_text-white"
                                            ...
                                            style="text-decoration: none;outline: none;color: #ffffff;"><img
                                                src="{{ asset('images/logo/logo.png') }}" width="50" height="50"
                                                alt="Obillia"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="o_bb-primary" height="40" width="32"
                                                    style="border-bottom: 1px solid #09596f;">&nbsp; </td>
                                                <td rowspan="2" class="o_sans o_text o_text-secondary o_px o_py"
                                                    ...
                                                    <img src="https://cdn-icons-png.flaticon.com/512/2875/2875394.png"
                        ...
                        <tbody>
                            <tr>
                                <td class="o_bg-white o_px-md o_py o_sans o_text-xs o_text-light" align="center"
                                    ...
                                    <p class="o_mb" style="margin-top: 0px;margin-bottom: 16px;"><strong>E-mail
                                            Address</strong></p>
                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                                        <tbody>
                                            <tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td width="300" class="o_btn o_bg-primary o_br o_heading o_text"
                                                    align="center"
                                                    style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;mso-padding-alt: 12px 24px;background-color: #09596f;border-radius: 4px;">
                                                    <a class="o_text-white" href="{{ $url }}"
                                                        style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 12px 24px;mso-text-raise: 3px;">Verify
                                                        My E-mail Address</a>
                                                </td>
                                            </tr>
                                        </tbody>
                        ...
                        <tbody>
                            <tr>
                                <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center"
                                    ...
                                    <p style="margin-top: 0px;margin-bottom: 0px;">
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita quia vitae
                                        quam perferendis ad culpa quos. Unde iure laudantium cumque, recusandae
                                        perspiciatis labore numquam neque doloribus. Repellat, cumque quisquam!
                                        Architecto.
                                    </p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="o_bg-white o_px-md o_py-lg o_bt-light o_br-b o_sans o_text-xs o_text-light"
                                    ...
                                    <p class="o_mb" style="margin-top: 0px;margin-bottom: 16px;"><a
                                            class="o_text-primary" href="{{ route('index') }}"
                                            style="text-decoration: none;outline: none;color: #09596f;"><img
                                                src="{{ asset('images/logo/logo.png') }}" width="36"
                                                height="36" alt="Obillia"
                                    ...
                                    <p class="o_mb" style="margin-top: 0px;margin-bottom: 16px;">©2023 Obillia Inc
                                    </p>

                                    {{-- <p style="margin-top: 0px;margin-bottom: 0px;">
                                        <a class="o_text-light o_underline" href="{{route('index')}}"
